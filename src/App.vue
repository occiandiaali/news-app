      ...
      <q-scroll-area class="fit">
        <q-list padding class="text-grey-8">
          <q-item class="GNL__drawer-item" v-ripple v-for="link in links1" :key="link.text" clickable>
            ...
            <q-item-section>
              <q-item-label @click="$router.push(`${link.link}`)">{{ link.text }}</q-item-label>
            </q-item-section>
          </q-item>
...
export default {
  ...
  setup () {
    ...
    return {
      ...
      links1: [
        { icon: 'web', text: 'Top stories', link: '/top' },
        { icon: 'person', text: 'For you', link: '/for-you' },
      ],
      links2: [
        
        { icon: fasEarthAmericas, text: 'World', link: '/world' },
 
        { icon: 'domain', text: 'Business' },
        { icon: 'memory', text: 'Technology', link: '/tech' },
